...
export namespace Prisma {
  ...
  */
  ...
  export type ProductSelect = {
    ...
    updates?: boolean | Product$updatesArgs
  ...
  export type ProductGetPayload<S extends boolean | null | undefined | ProductArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'updates' ? Array < UpdateGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'updates' ? Array < UpdateGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__ProductClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    updates<T extends Product$updatesArgs= {}>(args?: Subset<T, Product$updatesArgs>): Prisma.PrismaPromise<Array<UpdateGetPayload<T>>| Null>;
   ...
   * Product.updates
   */
  export type Product$updatesArgs = {
    /**
  ...
  export interface UpdateDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<UpdateGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__UpdateClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    updatePoints<T extends Update$updatePointsArgs= {}>(args?: Subset<T, Update$updatePointsArgs>): Prisma.PrismaPromise<Array<UpdatePointGetPayload<T>>| Null>;
  ...
  export interface UpdatePointDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<UpdatePointGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__UpdatePointClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
  ...
  export type UpdatePointWhereInput = {
    ...
    updatePointId?: StringFilter | string
  ...
  export type UpdatePointScalarWhereWithAggregatesInput = {
    ...
    updatePointId?: StringWithAggregatesFilter | string
  }
  ...
  export type UpdatePointUncheckedUpdateInput = {
    ...
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    updatePointId?: StringFieldUpdateOperationsInput | string
  }
